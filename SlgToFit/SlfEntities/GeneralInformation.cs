...
namespace SlfToFit.SlfEntities
{
		...
		Dictionary<string, ulong> sharingInfo)
	{
		...
		public readonly float ExcerciseTime = excerciseTime/100;                            // Total exercise time
		...
		public readonly float PauseTime = pauseTime/100;                                    // Total pause time
		...
		public readonly float TrainingTimeDownhill = trainingTimeDownhill/100;              // Training time downhill
		...
		public readonly float TimeInIntensityZone3 = timeInIntensityZone3/100;              // Time in intensity zone 3
		public readonly float TimeInIntensityZone4 = timeInIntensityZone4/100;              // Time in intensity zone 4
		public readonly float TimeInPowerZone1 = timeInPowerZone1/100;                      // Time in power zone 1
		public readonly float TimeInPowerZone2 = timeInPowerZone2/100;                      // Time in power zone 2
		public readonly float TimeInPowerZone3 = timeInPowerZone3/100;                      // Time in power zone 3
		public readonly float TimeInPowerZone4 = timeInPowerZone4/100;                      // Time in power zone 4
		public readonly float TimeInPowerZone5 = timeInPowerZone5/100;                      // Time in power zone 5
		public readonly float TimeInPowerZone6 = timeInPowerZone6/100;                      // Time in power zone 6
		public readonly float TimeInPowerZone7 = timeInPowerZone7/100;                      // Time in power zone 7
		public readonly float TimeOverIntensityZone = timeOverIntensityZone/100;            // Time over intensity zone
		public readonly float TimeUnderIntensityZone = timeUnderIntensityZone/100;          // Time under intensity zone
		public readonly int TrackProfile = trackProfile;                                    // Profile of the track
		public readonly float TrainingTime = trainingTime/100;                              // Total training time
		...
		public readonly float Best5KTime = best5KTime/100;                                  // Best 5K time
		...
		public readonly float PedalingTime = pedalingTime/100;								// Total pedaling time
