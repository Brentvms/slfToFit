...
namespace SlfToFit.SlfEntities
{
		...
		int speedTime)
	{
		...
		public readonly float TrainingTime = trainingTime/100;                              // Training time
		public readonly float TrainingTimeAbsolute = trainingTimeAbsolute/100;              // Absolute training time
		...
		public readonly float TimeBelowIntensityZones = timeBelowIntensityZones/100;        // Time below intensity zones
		...
		public readonly float TimeAboveIntensityZones = timeAboveIntensityZones/100;        // Time above intensity zones
		...
		public readonly float SpeedTime = speedTime/100;                                    // Speed time
